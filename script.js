...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const successClass = 'form-success';
    ...
    // Handle dynamically added animated elements
    if (window.MutationObserver) {
        const mutationObserver = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                mutation.addedNodes.forEach(function(node) {
                    if (node.nodeType === 1) {
                        if (node.matches && node.matches('.fade-in, .fade-in-up, .fade-in-left, .fade-in-right')) {
                            observer.observe(node);
                        }
                        if (node.querySelectorAll) {
                            const nestedElements = node.querySelectorAll('.fade-in, .fade-in-up, .fade-in-left, .fade-in-right');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e878f82b-1bce-4a97-b015-5b8d95c4f1e9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e878f82b-1bce-4a97-b015-5b8d95c4f1e9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e878f82b-1bce-4a97-b015-5b8d95c4f1e9';
